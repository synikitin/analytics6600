...
8. Note that some column names in your combined dataset actually stand for genres. We want to obtain a data frame containing two variables: genres and their count. Combine `gather` from **tidyr** and `count`, `count`, `filter` functions from **dplyr** to accomplish this. Which genre was least and which genre was most produced?
